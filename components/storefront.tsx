    ...
    <>
      ...
      {cartOpen ? (
        <div className="fixed inset-0 z-[55]" role="dialog" aria-modal="true" aria-label="Shopping bag">
          ...
          <aside className={`drawer-shadow absolute right-0 top-0 flex h-full w-full max-w-[460px] flex-col bg-[#fffdf8] ${checkoutOpen ? "overflow-y-auto" : "overflow-hidden"}`}>
            ...
            <div className={`no-scrollbar min-h-0 px-5 py-5 sm:px-7 ${checkoutOpen ? "" : "flex-1 overflow-y-auto"}`}>
